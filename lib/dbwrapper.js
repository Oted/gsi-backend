...
var keepTheseKeys   = {_id : 0, _hash : 1, data : 1, title : 1, type : 1, score : 1, _sort : 1, likes : 1, dislikes : 1, source : 1, source_type : 1};

//enum schema types
var itemTypes       = ['youtube', 'img', 'gif', 'soundcloud', 'vimeo', 'vine', 'text', 'video', 'twitch', 'instagram', 'sound', 'other'];
