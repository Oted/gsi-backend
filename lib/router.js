...
Router.prototype.postFeedback = function(request, reply) {
    ...
    dbWrapper.createFeedback(raw, function(err, doc) {
        if (err || !doc) {
...
Router.prototype.noVote = function(request, reply) {
    ...
    dbWrapper.vote(session, hash, ip, 0, adjective, function(err, doc) {
        if (err) {
...
Router.prototype.upVote = function(request, reply) {
    ...
    dbWrapper.vote(session, hash, ip, 1, adjective, function(err, doc) {
        if (err) {
            console.error(err);
            return reply().code(401);
        }
...
Router.prototype.viewedItem = function(request, reply) {
    ...
    dbWrapper.view(session, hash, ip, raw.view_time, function(err, doc) {
        if (err) {
            return reply().code(401);
        }
...
Router.prototype.getInfo = function(request, reply) {
    ...
    dbWrapper.getInfo(function(err, doc) {
        if (err) {
            return reply({'status' : 'not_found', 'error' : err}).code(400);
        }
